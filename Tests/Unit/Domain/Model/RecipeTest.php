...
{
    /**
     * @var \SNSVLP\CocktailSnSvLp\Domain\Model\Recipe
     */
    ...
    {
        parent::setUp();
        $this->subject = new \SNSVLP\CocktailSnSvLp\Domain\Model\Recipe();
    }
    ...
    {
        $tag = new \SNSVLP\CocktailSnSvLp\Domain\Model\Tag();
    ...
    {
        $step = new \SNSVLP\CocktailSnSvLp\Domain\Model\Step();
    ...
    {
        $cocktailFixture = new \SNSVLP\CocktailSnSvLp\Domain\Model\Cocktail();
    ...
    {
        $utensil = new \SNSVLP\CocktailSnSvLp\Domain\Model\Utensil();
    ...
    {
        $quantity = new \SNSVLP\CocktailSnSvLp\Domain\Model\Quantity();
